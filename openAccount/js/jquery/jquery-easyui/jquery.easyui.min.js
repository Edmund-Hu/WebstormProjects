...
_a37(this,q);
}},currentText:"Today",longDateText:"LongDate",cleanText:"Clean",closeText:"Close",okText:"Ok",buttons:[{text:function(_a4c){
...
return $(_a4i).datebox("options").longDateText;
},handler:function(_a4j){
$(_a4j).datebox("setValue",'2099-12-31').datebox("setText",'2099-12-31');
$(this).closest("div.combo-panel").panel("close");
}},{text:function(_a4g){
return $(_a4g).datebox("options").cleanText;
},handler:function(_a4h){
$(_a4h).datebox("setValue",'').datebox("setText",'');
$(this).closest("div.combo-panel").panel("close");
}}],formatter:function(date){
