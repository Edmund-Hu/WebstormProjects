...
/**
 * 移除esayui commbox getData数组指定value的option
 * @returns
 */
function removeOption(dataArr, value){
...
/**
 * 产品取消开通时，清楚对应下拉option，关闭窗口
 * @param value option value
 */
function closePD(value){
...
function getIdTypeText(idType){
	...
	if(idType=="01"){
		...
		bIdTypeText ="港澳居民往来内地通行证-香港";	
	}else if(idType=="48"){
		bIdTypeText ="港澳居民往来内地通行证-澳门";
	}else if(idType=="49"){
		bIdTypeText ="台湾居民来往大陆通行证";
	}else if(idType=="21"){
	 	bIdTypeText = "企业法人营业执照";
	}else if(idType=="22"){
		bIdTypeText = "企业营业执照";
	}else if(idType=="23"){
		bIdTypeText = "政府人事部门或编制委员会的批文";
	}else if(idType=="24"){
		bIdTypeText = "事业单位法人登记证书";
	}else if(idType=="25"){
		bIdTypeText = "军队开户核准通知书";
	}else if(idType=="26"){
		bIdTypeText = "社会团体登记证书";
	}else if(idType=="27"){
		bIdTypeText = "上级主管部门批文或证明";
	}else if(idType=="28"){
		bIdTypeText = "工会法人资格证书";
	}else if(idType=="29"){
		bIdTypeText = "民办非企业登记证书";
	}else if(idType=="30"){
		bIdTypeText = "驻华机构登记证";
	}else if(idType=="31"){
		bIdTypeText = "个体工商户营业执照";
	}else if(idType=="32"){
		bIdTypeText = "企业名称预先核准通知书";
	}else if(idType=="33"){
		bIdTypeText = "组织机构代码证";
	}else if(idType=="34"){
		bIdTypeText = "国税登记证";
		...
		bIdTypeText = "进出口业务资格证书";
	}else if(idType=="38"){
		bIdTypeText = "外贸易经营者备案登记表";
	}else if(idType=="39"){
		bIdTypeText = "金融许可证";
	}else if(idType=="40"){
		bIdTypeText = "外汇业务核准件";
		...
		bIdTypeText = "宗教事务管理部门批文或证明";
	}else if(idType=="50"){
		bIdTypeText = "机构信用代码";
	}else if(idType=="51"){
		bIdTypeText = "武警部队开户核准通知书";
	}else if(idType=="99"){
		bIdTypeText = "内部识别号";
	}
	return bIdTypeText;
