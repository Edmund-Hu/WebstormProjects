...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	function forSearchAcc(){
		...
		dataJson["openBankCode"] = openBankCode;
		dataJson["openBankName"] = openBankName;
		
		var ajax = new stAjax("forSearchAcc.action");
	...
	function accountConfirm(){
		var accountCode = $("#accountCode").textbox("getValue");
		var ajax = new stAjax("addSuspendAcc.action");
		ajax.setData({"accountCode":accountCode});
		ajax.setSuccessCallback(function(data) {
			if(data.success){
...
<form name="closeWin" id="closeWin" action="">
	<div class="easyui-panel" title="加注久悬银行账户" iconCls="ico_280"
		style="width: 100%;">
		<div class="lin_system">
			<div class="lin_system_main">
				...
				<div class="lin_system_details">
					...
					<div class="role_window_input">
						<input class="easyui-textbox" id="openBankCode" name="openBankCode" disabled="disabled" value='<s:property value="openBankCode"/>'
						style="width: 100%; height: 32px">
					</div>
				</div>
				<div class="lin_system_details">
					...
					<div class="role_window_input">
						<input class="easyui-textbox" id="openBankName" name="openBankName" disabled="disabled" value='<s:property value="openBankName"/>'
						style="width: 100%; height: 32px">
					</div>
				</div>
...
<div id="accMsgDiv"  class="easyui-window" title="加注久悬银行账户－>信息核对" data-options="modal:true,closed:true,iconCls:'ico_281'" style="width:80%;height:95%;">
	<div class="role_window">
				...
				<div class="role_window_button">
					...
					<a href="javascript:void(0)" class="easyui-linkbutton" data-options="iconCls:'ico_287'"
